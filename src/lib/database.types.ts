...
//
// For now, here are manual type definitions matching the schema:
  ...
  public: {
    Tables: {
      ...
      retailer_profiles: {
        ...
        Update: Partial<Database['public']['Tables']['retailer_profiles']['Insert']>;
      };
      products: {
        Row: {
          id: string;
      ...
      attributions: {
        ...
        Update: Partial<Database['public']['Tables']['attributions']['Insert']>;
      };
      points_ledger: {
        Row: {
          id: string;
      ...
      brand_retailer_partnerships: {
        ...
        Update: Partial<Database['public']['Tables']['brand_retailer_partnerships']['Insert']>;
      };
    };
    Functions: {
      get_points_balance: {
